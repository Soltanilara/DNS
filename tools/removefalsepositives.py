...
##        print(max(h) - min(h))
    ...
    ## ----------------------------------- Removing False Positives -----------------------------
        ...
        for vi in iii:
            print(vi)
            print(h[vi], h[vi+1], h[vi+2], h[vi+3])
            print(percentage_diff(h[vi], h[vi+1]))
            print(percentage_diff(h[vi], h[vi+5]))
            print(percentage_diff(h[vi], h[vi+10]))
            print(percentage_diff(h[vi], h[vi+15]))
            print(percentage_diff(h[vi], h[vi+20]))
            if percentage_diff(h[vi], h[vi+2]) - percentage_diff(h[vi], h[vi+1]) > 3:
                falsepos = False
            elif percentage_diff(h[vi], h[vi+3]) - percentage_diff(h[vi], h[vi+1]) > 5:
                falsepos = False
            else:
                falsepos = True
            if falsepos == True:
